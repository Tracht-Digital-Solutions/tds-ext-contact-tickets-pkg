 ...
 */
final class ContactTicketsApiDocsTest extends TestCase
{
    ...
    private static function mountedRoutes(): array
    {
        ...
        $registry = new ModuleRegistry([new ContactTicketsModule()]);
    ...
    private static function documentedRoutes(): array
    {
        return array_map(
            ...
            (new ContactTicketsModule())->apiDocs(),
        );
    }
    ...
    public function testEveryEntryIsWellFormed(): void
    {
        $permissions = array_map(
            ...
            (new ContactTicketsModule())->permissions(),
        );

        foreach ((new ContactTicketsModule())->apiDocs() as $doc) {
